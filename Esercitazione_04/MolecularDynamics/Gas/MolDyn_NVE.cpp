...
//        ConfXYZ(nconf);//Write actual configuration in XYZ format //Commented to avoid "filesystem full"!       
    ...
    if(i==0){
      ...
      Ave_etot<< i << " "<<mean_prog_etot<<" "<<setprecision(100)<<sqrt((mean2_prog_etot-mean_prog_etot*mean_prog_etot)/(i))<<endl;      
    }      
  }
...
void ConfFinal(void){ //Write final configuration
  ...
  ofstream WriteOut;
    ...
    cout << "Print final configuration to  old.final " << endl;
    cout << "Print previous configuration to  old.0" << endl << endl;  
